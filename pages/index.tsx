    ...
    <Layout footer>
      ...
      <div>
        <div className="text-white flex flex-col">
          <a href="#">
            <button className="bg-black hover:bg-gray-700 rounded-lg p-3 font-semibold">
              <div className="whitespace-nowrap">
                ...
                <p className="inline-block text-lg align-middle">Github</p>
              </div>
            </button>
          </a>
          <a href="#">
            <button className="bg-blue-500 hover:bg-blue-400 rounded-lg p-3 font-semibold">
              <div className="whitespace-nowrap">
                <svg
                  viewBox="0 0 24 24"
                  className="fill-current inline-block w-10 pr-1"
                ...
                <p className="inline-block text-lg align-middle">Twitter</p>
              </div>
            </button>
          </a>
          <a href="#">
            <button className="bg-gradient-to-tl from-red-600 via-purple-600 to-blue-600 rounded-lg p-3 hover:from-red-500 hover:via-purple-500 hover:to-blue-500 font-semibold">
              <svg
                fill="#ffffff"
              ...
              <p className="inline-block text-lg align-middle">Instagram</p>
            </button>
          </a>
          <a href="#">
            <button className="bg-indigo-600 hover:bg-indigo-500 rounded-lg p-3 font-semibold">
              <svg
                version="1.1"
                id="Capa_1"
