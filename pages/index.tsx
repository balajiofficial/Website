          ...
          <div className="lg:pt-48 md:pt-36 sm:pt-12 pt-20">
            ...
            <div className="flex justify-center mt-3 md:mt-7">
              <div className="text-white dark:text-white flex md:justify-evenly w-auto md:w-11/12 lg:w-3/4 flex-col md:flex-row">
                ...
                <div className="pt-3 pb-3">
                  <button
                    className="bg-blue-500 hover:bg-blue-600 dark:hover:bg-blue-400 dark:hover:shadow-gray-600 rounded-lg p-3 font-semibold h-14 hover:shadow-xl hover:-translate-y-1 transform transition-all duration-150"
                    onClick={() => {
                ...
                <div className="pt-3 pb-3">
                  <button
                    className="bg-gradient-to-tl from-red-600 via-purple-600 to-blue-600 rounded-lg p-3 dark:hover:from-red-500 dark:hover:via-purple-500 dark:hover:to-blue-500 hover:from-red-700 hover:via-purple-700 hover:to-blue-700 dark:hover:shadow-gray-600 font-semibold h-14 hover:shadow-xl hover:-translate-y-1 transform transition-all duration-150"
                    onClick={() => {
