export const content: Array<Array<string>> = [
  [
    "Data Plotter",
    ...
    "April 2021",
    "https://raw.githubusercontent.com/balajiofficial/DataPlotter/main/images/Screenshot.png",
  ],
  [
    "Website",
    "The site has been created using next.js, react and typescript. The site has been deployed on vercel. It stores the theme choice using local storage. The website uses Tailwind CSS for the UI and Heroicons for SVG Icons. Next.js enables the site to load web pages and images instantly. The blog posts are dynamically rendered and are markdown files converted to HTML. The github pages site that redirects to the main site.",
    "April 2021",
    "https://raw.githubusercontent.com/balajiofficial/balajiofficial.github.io/main/images/Screenshot.png",
  ],
  [
    "EncryptCLI",
    ...
    "March 2021",
    "https://raw.githubusercontent.com/balajiofficial/EncryptCLI/main/images/Screenshot.png",
  ],
  [
    "Bala Notes",
    ...
    "March 2021",
    "https://raw.githubusercontent.com/balajiofficial/BalaNotes/main/images/Screenshot.png",
  ],
  [
    ...
    "December 2020",
    "https://raw.githubusercontent.com/balajiofficial/CompetitiveProgramming/main/images/Screenshot.png",
  ],
];
